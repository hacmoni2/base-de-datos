...
Los tres artículos seleccionados fueron publicados entre 2020 y 2021 y cuentan con DOI. Además, fueron publicados en revistas o congresos académicos relacionados con el área de bases de datos. Uno de ellos tiene una relación directa con la inteligencia artificial, lo cual resulta especialmente relevante dentro de una formación en Ingeniería en Inteligencia Artificial.
...
Uno de los aspectos más interesantes de la propuesta es que la inteligencia artificial no se utiliza únicamente como un recurso adicional, sino como una herramienta para resolver un problema específico de administración y optimización de bases de datos.
...
El trabajo muestra que existe una posibilidad de combinar técnicas de aprendizaje automático con sistemas gestores de bases de datos para conseguir que estos puedan adaptarse mejor a diferentes situaciones y cargas de trabajo.
...
## 1.6. Aportación para el proyecto del curso

Este artículo permite comprender que trabajar con una base de datos no significa solamente crear tablas, insertar registros y realizar consultas. También es importante conocer cómo se comporta el sistema cuando aumenta la cantidad de información o cuando se realizan muchas operaciones.

Para el proyecto del curso, esto puede ser útil al considerar aspectos como el rendimiento de PostgreSQL y la posibilidad de utilizar herramientas automáticas para analizar o mejorar el funcionamiento de una base de datos.
...
## 2.6. Aportación para el proyecto del curso

Este artículo permite considerar que una base de datos no debe evaluarse solamente por si permite guardar y recuperar información. También es necesario pensar en qué tan confiable es la información que se está almacenando.

En el proyecto con PostgreSQL, esto puede relacionarse con aspectos como las restricciones de integridad, los permisos de usuarios, las copias de seguridad y las medidas necesarias para evitar modificaciones incorrectas de los datos.
...
Resulta interesante que el artículo combine conceptos de bases de datos con técnicas de optimización matemática y predicción. Esto demuestra que el rendimiento de una base de datos puede estudiarse como un problema de optimización.
...
## 3.6. Aportación para el proyecto del curso

Este artículo permite comprender que una base de datos debe analizarse también desde el punto de vista del rendimiento. En un proyecto con PostgreSQL, por ejemplo, no solamente importa que una consulta entregue el resultado correcto, sino también cuánto tiempo tarda en hacerlo y qué recursos utiliza.

Esto puede servir posteriormente para estudiar índices, planes de ejecución y diferentes formas de escribir consultas SQL que permitan obtener los resultados de manera más eficiente.

---

# Comparación de los tres artículos

Después de revisar los tres artículos, se puede observar que una de las principales características que tienen en común es que ninguno se limita al almacenamiento básico de información. Los tres estudian problemas que aparecen cuando una base de datos se utiliza en situaciones más complejas y donde es necesario mejorar alguna de sus características.
...
A partir de la revisión de estos artículos, se identifica como problema abierto la dificultad de integrar simultáneamente **rendimiento, seguridad y automatización inteligente** en un mismo sistema gestor de bases de datos. Mejorar una característica puede introducir nuevos costos o restricciones en otra. Por ejemplo, los mecanismos de verificación de integridad pueden requerir recursos adicionales, mientras que la automatización mediante modelos de aprendizaje automático necesita datos y evaluaciones confiables para tomar decisiones adecuadas.

Desde la perspectiva de la Ingeniería en Inteligencia Artificial, una línea de investigación interesante consiste en desarrollar sistemas de bases de datos capaces de analizar sus propias cargas de trabajo, optimizar consultas y mantener garantías de integridad sin aumentar excesivamente la complejidad de su administración. Esto representa un desafío que relaciona los fundamentos de las bases de datos con la optimización, la seguridad y el aprendizaje automático.

En conclusión, la revisión de estos tres artículos permite observar que el área de bases de datos continúa evolucionando y que actualmente existe una relación cada vez mayor entre las bases de datos, la inteligencia artificial, la seguridad y la optimización. Para la formación en esta área, esto es importante porque permite entender que aprender SQL y diseñar tablas es solamente una parte del trabajo. También es necesario comprender qué sucede internamente cuando los datos son almacenados, consultados, protegidos y procesados.
